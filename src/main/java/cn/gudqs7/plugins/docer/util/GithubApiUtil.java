...
public class GithubApiUtil {
    ...
    private static final String GITHUB_TOKEN = "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";
    ...
    public static String searchIssue(String body) {
        ...
        String query = "q=" + URLEncoder.encode(q, StandardCharsets.UTF_8) + "&page=1&per_page=1";
    ...
    private static Map<String, String> getAuthHeader() {
        ...
        head.put("Authorization", "token " + GITHUB_TOKEN);
        return head;
    }
