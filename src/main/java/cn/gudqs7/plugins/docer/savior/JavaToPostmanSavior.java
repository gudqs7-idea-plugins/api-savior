...
public class JavaToPostmanSavior extends AbstractDocSavior {
    ...
    public Map<String, Object> generatePostmanItem(PsiClass psiClass, Project project) {
        ...
        String itemName = apiModelProperty.getItemName(psiClass.getName());
        ...
        String hostAndPort = "";
        boolean noResponse = apiModelProperty.getSingleBool("noResponse", false);
    ...
    public Map<String, Object> generatePostmanRequestByMethod(Project project, String interfaceClassName, PsiMethod publicMethod, boolean noResponse) {
        Map<String, String> data = getData(project, interfaceClassName, publicMethod, false);
        if (data == null) {
            return null;
        }
        ...
        String noResponseStr = data.get("noResponse");
        // 就近原则, 方法上存在配置则优先方法
        if (!"null".equals(noResponseStr)) {
            noResponse = Boolean.parseBoolean(noResponseStr);
        }
