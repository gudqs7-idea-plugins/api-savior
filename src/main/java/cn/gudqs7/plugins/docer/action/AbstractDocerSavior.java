...
public abstract class AbstractDocerSavior extends AnAction {
    ...
    private final JavaToDocSavior docSavior;
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        try {
            ...
            if (isRightClickOnMethod) {
                ...
                String interfaceClassName = containingClass.getQualifiedName();
                String docByMethod = docSavior.generateDocByMethod(project, interfaceClassName, psiMethod, true);
