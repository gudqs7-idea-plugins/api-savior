 ...
 * @date 2021/10/1
 */
public class SetterGenerate extends AbstractDefaultValGenerate {

    private final boolean noSupperClass;

    public SetterGenerate(boolean generateDefaultVal, BaseVar baseVar) {
        this(generateDefaultVal, baseVar, false);
    }

    public SetterGenerate(boolean generateDefaultVal, BaseVar baseVar, boolean noSupperClass) {
