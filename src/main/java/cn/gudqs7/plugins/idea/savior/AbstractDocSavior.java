...
import cn.gudqs7.plugins.idea.pojo.annotation.ResponseCodeInfo;
...
public class AbstractDocSavior extends BaseSavior {
    ...
    protected boolean filterMethod(PsiMethod method) {
        ...
        if ("LombokLightModifierList".equals(modifierList.toString())) {
            return true;
        }
        return false;
    }

    protected Map<String, String> getData(Project project, String interfaceClassName, PsiMethod publicMethod) {
        ...
        hidden = apiModelProperty.isHidden(hidden);
        ...
        String java2api = "";
        Map<String, Object> java2json = new HashMap<>();
        ...
        boolean methodIsGet = RequestMapping.Method.GET.equals(method0);
        boolean paramHasRequestBody = RequestMapping.ContentType.APPLICATION_JSON.equals(contentType);
        theme.handleJsonExampleAndUrl(java2json, singleParam, paramHasRequestBody, methodIsGet, data, url);
        return data;
    }
